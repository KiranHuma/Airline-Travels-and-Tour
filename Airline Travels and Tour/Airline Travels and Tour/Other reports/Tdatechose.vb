...
Public Class Tdatechose
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cn.Open()
        Dim str As String = "select * from ticket where dte >= '" & Format(dfrom, "MM-dd-yyyy") & "' and dte <='" & Format(dto, "MM-dd-yyyy") & "'"
    ...
    Private Sub Tdatechose_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dbaccessconnection()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            Dim rprt As New CRTdtet 'The report you created.
            ...
            MyCommand.CommandText = "select * from ticket where dte >= '" & Format(dfrom, "MM-dd-yyyy") & "' and dte <='" & Format(dto, "MM-dd-yyyy") & "'"
            MyCommand.CommandType = CommandType.Text
            myDA.SelectCommand = MyCommand
            myDA.Fill(myDS, "ticket")
            rprt.SetDataSource(myDS)
            rprtTdte.CrystalReportViewer1.ReportSource = rprt
            rprtTdte.Show()
        Catch ex As Exception
