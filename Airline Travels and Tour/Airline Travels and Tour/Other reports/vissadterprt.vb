...
Public Class vissadterprt
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            Dim rprt As New CRDvisa 'The report you created.
            ...
            MyCommand.CommandText = "select * from vissa where vdte  >= '" & Format(dfrom, "MM-dd-yyyy") & "' and vdte <='" & Format(dto, "MM-dd-yyyy") & "'"
            MyCommand.CommandType = CommandType.Text
            myDA.SelectCommand = MyCommand
            myDA.Fill(myDS, "vissa")
    ...
    Private Sub vissadterprt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        dbaccessconnection()
    End Sub
End Class