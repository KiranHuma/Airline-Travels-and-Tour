...
Public Class CRmainfoffce
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Airline_Travels_and_Tour.CRmainfoffce.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRmainfoffce
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRmainfoffce = New CRmainfoffce()
        rpt.Site = Me.Site
        Return rpt
    End Function
